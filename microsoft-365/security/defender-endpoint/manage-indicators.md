...
- Warn - the IoC will trigger a prompt that can be bypassed by the end user.
...
| [URLs and domains](indicator-ip-domain.md) | Allow <br> Audit <br> Warn (Preview) <br> Block execution |
